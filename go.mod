module github.com/leitiannet/einolib

go 1.25.0

require (
	github.com/cloudwego/eino v0.9.0-alpha.15
	...
	github.com/cloudwego/eino-ext/components/tool/duckduckgo/v2 v2.0.0-20260311121809-88ebb0eecbdb
...
require (
	...
	github.com/cloudwego/eino-ext/adk/backend/agentkit v0.2.5 // indirect
